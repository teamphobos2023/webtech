				...
				<div class="row">
					<div class="col-md-22">
						...
						<div class="newsletter">
							<p>Sign Up for the <strong>OFFERS UPDATES</strong></p>
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/profile.php?id=61551880005897&mibextid=ZbWKwL"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
